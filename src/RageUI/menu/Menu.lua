...
if Config.SelectPosition == 0 then
    MENUSelectPosition = 0
elseif Config.SelectPosition == 1 then
    MENUSelectPosition = 1420
end
...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or "banner", Texture = TextureName or "interaction_bgd", Color = { R = 0, G = 0, B = 0, A = 0 } }
    Menu.Rectangle = nil
